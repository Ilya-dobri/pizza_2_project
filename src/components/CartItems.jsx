...
function CartItems({id, name, type, size, totalCount, totalPrice, onRemoveItem, onPlusItem, onMinusItem }) {
  ...
  return (
    <div className='cart__item'>
      ...
      <div className='cart__item-remove'>
        <Button onClick={handRemoveClick} className='button button--outline button--circle'>
          <svg
            width='10'
            height='10'
            viewBox='0 0 10 10'
